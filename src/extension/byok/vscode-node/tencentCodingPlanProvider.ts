...
const TENCENT_CODING_PLAN_ANTHROPIC_BASE_URL = 'https://api.lkeap.cloud.tencent.com/coding/anthropic';
...
export class TencentCodingPlanLMProvider extends AbstractLanguageModelChatProvider {
	...
	protected async getAllModels(silent: boolean, apiKey: string | undefined): Promise<ExtendedLanguageModelChatInformation<LanguageModelChatConfiguration>[]> {
		...
		return byokKnownModelsToAPIInfo(this._name, TENCENT_CODING_PLAN_STATIC_MODELS) as ExtendedLanguageModelChatInformation<LanguageModelChatConfiguration>[];
	}
	...
	async provideLanguageModelChatResponse(
		...
		const anthropicClient = new Anthropic({
			apiKey,
			baseURL: TENCENT_CODING_PLAN_ANTHROPIC_BASE_URL,
		});
